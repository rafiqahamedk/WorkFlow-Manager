      ...
      <div className="flex items-center gap-3 px-5 py-4">
        ...
        {editing ? (
          <div className="flex gap-2 flex-1 flex-wrap items-center">
            ...
            <button onClick={handleSave} className="bg-violet-600 hover:bg-violet-500 text-white px-3 py-1.5 rounded-lg text-sm transition-colors">Save</button>
            <button onClick={() => setEditing(false)} className="text-slate-500 hover:text-slate-300 text-sm transition-colors">Cancel</button>
          </div>
        ) : (
          <>
            ...
            <button onClick={() => setEditing(true)} className="p-1.5 rounded-lg text-slate-500 hover:text-slate-300 hover:bg-slate-800 transition-colors text-sm">✎</button>
            <button onClick={() => onDelete(step._id)} className="p-1.5 rounded-lg text-slate-600 hover:text-red-400 hover:bg-red-400/10 transition-colors text-sm">✕</button>
          </>
        )}
      </div>
