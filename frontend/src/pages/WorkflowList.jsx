              ...
              <tr>
                <td colSpan={6} className="px-5 py-16 text-center">
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <button type="button" onClick={() => navigate('/workflows/new')} className="text-violet-400 text-sm hover:underline">Create your first workflow</button>
                  </div>
                </td>
              </tr>
            )}
              ...
              <tr key={wf._id} className="hover:bg-slate-800/30 transition-colors group">
                ...
                <td className="px-5 py-4">
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <button
                      type="button"
                      onClick={() => navigate(`/workflows/${wf._id}/steps`)}
                      className="px-3 py-1.5 rounded-md bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-medium transition-colors"
                    >
                      Steps
                    </button>
                    <button
                      type="button"
                      onClick={() => navigate(`/workflows/${wf._id}/rules`)}
                      className="px-3 py-1.5 rounded-md bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-medium transition-colors"
                    >
                      Rules
                    </button>
